...
class CreateAppointmentScreen extends StatefulWidget {
  static String id = "CreateAppointmentScreen";
  @override
...
class _CreateAppointmentScreenState extends State<CreateAppointmentScreen> {
  ...
  getDataCustommerProfile() async {
    ...
    customerProfileModelTmp = await createAppoinmentController
        .onGetCustomerProfile(document_id_custommer: document_id_custommer);
  ...
  onCreateAppointment() async {
    await createAppoinmentController
        .onCreateAppointment(
            document_id_user_handing:
        ...
        child: Column(
          ...
          children: <Widget>[
                  ...
                  GestureDetector(
                    ...
                    child: customerProfileModelCustomer == null
                        ? Material(
                            elevation: 2,
                            child: Container(
                              height: setHeightSize(size: 60),
                              child: Center(
                                child: Text("Vui lòng chọn khách hàng."),
                              ),
                            ),
                          )
                        : BuildItemUser(
                    ...
                    child: productModel == null
                        ? Material(
                            ...
                            child: Container(
                              height: setHeightSize(size: 60),
                              child: Center(
                                child: Text("Vui lòng chọn sản phẩm."),
                              ),
                            ),
                          )
                  ...
                  TextFieldBorder(
                    ...
                    onTap: () {
                      DatePicker.showDateTimePicker(context,
                        ...
                        time_metting = date;
                        setState(() {});
                      }, currentTime: time_metting, locale: LocaleType.vi);
                    },
                    readOnly: true,
            ...
            Center(
              child: Container(
                child: StreamBuilder(
                  stream: createAppoinmentController.errStream,
